...
export {};
//Метод introduce у класі Wizard - для представлення персонажа шляхом виведення рядка, що містить введений фразу та ім'я мага. У метод передається параметр phrase, який є рядком, що буде використаний для виведення повідомлення.
//Метод castSpell - для виклику чарівного заклинання або якоїсь магічної дії. У цьому випадку, метод просто виводить рядок у консоль, що імітує виклик чарівного заклинання.
